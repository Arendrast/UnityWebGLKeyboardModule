const mobileKeyboard = {
    $mobileKeyboardInstance: {
            ...
            if (!inputDiv) {
                ...
                inputDiv.addEventListener('keydown', (e) => {
                    if (e.key === 'Enter') {
                        ...
                        if (self.shouldClearTextAfterSubmit) inputDiv.innerHTML = '';
                        if (self.shouldCloseKeyboardAfterSubmit) self.closeKeyboard();
                    }
                });

                inputDiv.addEventListener('input', onInput);
                inputDiv.addEventListener('compositionend', onInput);
                inputDiv.addEventListener('keyup', onInput);
        ...
        openKeyboard: function(shouldSetInputDiv = false, shouldCloseKeyboardAfterSubmit = false, shouldReplaceEmojiTextToImage = true, shouldClearTextAfterSubmit = false, startText = null, color = null, backgroundColor = null, top = null, bottom = null, left = null, width = null, height = null, transform = null, position = null, border = null, fontSize = null) {
            ...
            this.shouldClearTextAfterSubmit = shouldClearTextAfterSubmit;
    ...
    // External C# calls
    OpenKeyboard: function(shouldCloseKeyboardAfterSubmit, shouldReplaceEmojiTextToImage, shouldClearTextAfterSubmit, startText, color, backgroundColor, top, bottom, left, width, height, transform, position, border, fontSize) {
        mobileKeyboardInstance.openKeyboard(true, shouldCloseKeyboardAfterSubmit, shouldReplaceEmojiTextToImage, shouldClearTextAfterSubmit, GetString(startText), GetString(color), GetString(backgroundColor), GetString(top), GetString(bottom), GetString(left), GetString(width), GetString(height), 
