Для поддержки мобильных клавиатур мы реализовывали своё решение - класс MobileWebGLKeyboardTools. Он вызывает функции из файла web-gl-mobile-keyboard.jslib (добавьте его в папку Assets/Plugins/WebGL)
