Для поддержки мобильных клавиатур мы реализовывали своё решение - класс MobileWebGLKeyboardTools. Он вызывает функции из файла web-gl-mobile-keyboard.jslib - его добавьте в папку Assets/Plugins/WebGL, в репозитории он лежит в папке WebGL
